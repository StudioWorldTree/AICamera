...
- GIVEN AGX QSFP28 is four independent MGBE controllers (DS-11945-001 4.10.1)
...
remain unspecified. USB-C SHALL NOT be the satellite trunk.
...
HEVC recording and metadata sidecars SHALL continue when AI decode,
overlay, or remux is dropped. Mode switch drops AI, never record.

#### Scenario: thermal sag
- GIVEN 1 body + 2 satellites recording
- WHEN slice-1 AI is killed or thermal sag drops overlay/AD
- THEN HEVC files and JSONL sidecars keep writing
